...
Database.main(r"results.db")
Database.insert_result(r"results.db", "yes", 0)
Database.delete_result(r"results.db", 1)
final = Database.get_results(r"results.db") # final is a cursor object
for row in final:
    print(row)